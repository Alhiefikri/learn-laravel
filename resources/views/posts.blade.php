<x-layout>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-16 sm:py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mt-4 text-lg leading-8 text-gray-300">Find articles, tutorials, and insights from our agile
                    team.</p>
    ...
    <div class="py-4 px-4 mx-auto max-w-7xl lg:py-8 lg:px-0 my-4">
